...
int main (int argc, char *argv[])
{
    ...
    for (uint16_t i = 1; i <= 4; i++)
    {
        ...
        if (i == 1)
        {
            ...
            nodePhy.Set ("Frequency", UintegerValue (5180));
        ...
        nodePhy.Set ("RxGain", DoubleValue (0) );
        ...
        NetDeviceContainer adhocDevs = wifi.Install (nodePhy, mac, adhocNodes);
        ...
        // Tracing
        nodePhy.EnablePcap ("wifi-adhoc-channels", adhocDevs);
