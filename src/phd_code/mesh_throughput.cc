...
MeshTest::CalculateThroughput ()
{
  ...
  double throughput = totalPacketsThrough * m_packetSize * 8 / (m_totalTime * 1000000.0); //Mbit/s
...
MeshTest::Run ()
{
  ...
  InstallApplication ();
  Simulator::Schedule(Seconds (m_totalTime-1), &MeshTest::CalculateThroughput, this);
